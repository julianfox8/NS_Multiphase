...
function run_solver(param, IC!, BC!)
    ...
    while nstep<stepMax && t<tFinal
        ...
        if solveNS
            ...
            iter = pressure_solver!(P,uf,vf,wf,t,dt,band,VF,param,mesh,par_env,denx,deny,denz,tmp1,tmp2,tmp3,tmp4,tmp5,tmp6,gradx,grady,gradz,verts,tets,BC!,jacob,b,x)
